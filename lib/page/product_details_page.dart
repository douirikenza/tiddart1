...
class ProductDetailsPage extends StatelessWidget {
  ...
  Future<String> fetchArtisanName(String artisanId) async {
    final doc = await FirebaseFirestore.instance.collection('artisans').doc(artisanId).get();
    if (doc.exists) {
      final data = doc.data();
      return data?['nom'] ?? data?['name'] ?? 'Artisan inconnu';
    }
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      product.artisan.isNotEmpty ? product.artisan[0] : '?',
                                      style: TextStyle(
                                        color: AppTheme.primaryBrown,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 18,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FutureBuilder<String>(
                                        future: fetchArtisanName(product.artisan),
